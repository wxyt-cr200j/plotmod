...
public class TSWHalfButton extends PictureButton{
    ...
    public void render(PoseStack ps, Font font,int mx,int my)
    {
        ...
        drawString(ps,font,coma,super.x1/2+super.w1/12/2,super.y1/2+super.h1/2-super.h1/3-super.h1/12,0xFFFFFF);
        ps.popPose();
        drawString(ps,font,comb,super.x1+super.w1/12,super.y1+super.h1-super.h1/9*2-super.h1/12*2,0xFFFFFF);
